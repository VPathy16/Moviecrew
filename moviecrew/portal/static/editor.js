...
(() => {
 ...
 function splitAtPlayhead(index){
  ...
  remember();cut.clips.splice(index,1,{...c,end:t},{...c,start:t});changed();renderCut();
 }
 ...
 async function showRegenerate(index){
  ...
  function body(){return {request_id:crypto.randomUUID(),shot_id:m.shot_id,frame_id:m.frame_id||'',anchor_position:m.anchor_position||'first_frame',
   ...
   regenerate_of:{video_id:c.video_id,start:c.start,end:c.end}}}
  let version=0;
